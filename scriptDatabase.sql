...
-----------------------------------USERS-----------------------------------------
DELIMITER $$
CREATE PROCEDURE PROC_CHANGE_FULL_NAME(
    IN N_USER_NAME VARCHAR(31),
    IN N_FULL_NAME NVARCHAR(50)
)
BEGIN
    UPDATE USERS 
    SET FULL_NAME = N_FULL_NAME
    WHERE N_USER_NAME LIKE USER_NAME;
END; $$
DELIMITER ;

DELIMITER $$
CREATE PROCEDURE PROC_CHANGE_GENDER(
    IN N_USER_NAME VARCHAR(31),
    IN N_GENDER BOOLEAN
)
BEGIN
...
DELIMITER $$
CREATE PROCEDURE PROC_CHANGE_MAIL(
    IN N_USER_NAME VARCHAR(31),
    IN N_MAIL VARCHAR(50)
)
BEGIN
...
DELIMITER $$
CREATE PROCEDURE PROC_CHANGE_PHONE(
    IN N_USER_NAME VARCHAR(31),
    IN PHONE VARCHAR(10)
)
BEGIN
    UPDATE USERS 
    SET PHONE = N_FULL_NAME
    WHERE N_USER_NAME LIKE USER_NAME;
END; $$
DELIMITER ;

DELIMITER $$
CREATE PROCEDURE PROC_CHANGE_DOB(
    IN N_USER_NAME VARCHAR(31),
    IN N_DOB LONG
)
BEGIN
...
CREATE PROCEDURE PROC_CREATE_ROOM(
    IN N_ROOM_CODE VARCHAR(51),
    IN N_USER_NAME VARCHAR(41),
    IN N_PASSWORD VARCHAR(64),
    IN N_ROOM_NAME NVARCHAR(50),
    IN MODE BOOLEAN)
BEGIN
    INSERT INTO ROOMS VALUES(N_ROOM_CODE, N_USER_NAME, N_PASSWORD, FALSE, MODE);
